            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb' )
                    <li class="menu {{ ($category_name === 'dashboard') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'dashboard') ? 'show' : '' }}" id="dashboard" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'sales') ? 'active' : '' }}">
                                <a href="/theme/sales"> Sales </a>
                            </li>
                            <li class="{{ ($page_name === 'analytics') ? 'active' : '' }}">
                                <a href="/theme/analytics"> Analytics </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ ($category_name === 'apps') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'apps') ? 'show' : '' }}" id="app" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'chat') ? 'active' : '' }}">
                                <a href="/theme/apps/chat"> Chat </a>
                            </li>
                            <li class="{{ ($page_name === 'mailbox') ? 'active' : '' }}">
                                <a href="/theme/apps/mailbox"> Mailbox  </a>
                            </li>
                            <li class="{{ ($page_name === 'todo-list') ? 'active' : '' }}">
                                <a href="/theme/apps/todoList"> Todo List </a>
                            </li>
                            <li class="{{ ($page_name === 'notes') ? 'active' : '' }}">
                                <a href="/theme/apps/notes"> Notes </a>
                            </li>
                            <li class="{{ ($page_name === 'scrumboard') ? 'active' : '' }}">
                                <a href="/theme/apps/scrumboard">Scrumboard</a>
                            </li>
                            <li class="{{ ($page_name === 'contacts') ? 'active' : '' }}">
                                <a href="/theme/apps/contacts"> Contacts </a>
                            </li>
                            <li class="{{ ($page_name === 'invoice') ? 'active' : '' }}">
                                <a href="/theme/apps/invoice"> Invoice List </a>
                            </li>
                            <li class="{{ ($page_name === 'calendar') ? 'active' : '' }}">
                                <a href="/theme/apps/calendar"> Calendar </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ ($category_name === 'components') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled  {{ ($category_name === 'components') ? 'show' : '' }}" id="components" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'tabs') ? 'active' : '' }}">
                                <a href="/theme/components/tabs"> Tabs </a>
                            </li>
                            <li class="{{ ($page_name === 'accordions') ? 'active' : '' }}">
                                <a href="/theme/components/accordions"> Accordions  </a>
                            </li>
                            <li class="{{ ($page_name === 'modals') ? 'active' : '' }}">
                                <a href="/theme/components/modals"> Modals </a>
                            </li>
                            <li class="{{ ($page_name === 'cards') ? 'active' : '' }}">
                                <a href="/theme/components/cards"> Cards </a>
                            </li>
                            <li class="{{ ($page_name === 'bootstrap_carousel') ? 'active' : '' }}">
                                <a href="/theme/components/carousel">Carousel</a>
                            </li>
                            <li class="{{ ($page_name === 'blockui') ? 'active' : '' }}">
                                <a href="/theme/components/blockui"> Block UI </a>
                            </li>
                            <li class="{{ ($page_name === 'countdown') ? 'active' : '' }}">
                                <a href="/theme/components/countdown"> Countdown </a>
                            </li>
                            <li class="{{ ($page_name === 'counter') ? 'active' : '' }}">
                                <a href="/theme/components/counter"> Counter </a>
                            </li>
                            <li class="{{ ($page_name === 'sweet_alerts') ? 'active' : '' }}">
                                <a href="/theme/components/sweet_alerts"> Sweet Alerts </a>
                            </li>
                            <li class="{{ ($page_name === 'timeline') ? 'active' : '' }}">
                                <a href="/theme/components/timeline"> Timeline </a>
                            </li>
                            <li class="{{ ($page_name === 'notifications') ? 'active' : '' }}">
                                <a href="/theme/components/notifications"> Notifications </a>
                            </li>
                            <li class="{{ ($page_name === 'session_timeout') ? 'active' : '' }}">
                                <a href="/theme/components/session_timeout"> Session Timeout </a>
                            </li>
                            <li class="{{ ($page_name === 'media_object') ? 'active' : '' }}">
                                <a href="/theme/components/media_object"> Media Object </a>
                            </li>
                            <li class="{{ ($page_name === 'list_group') ? 'active' : '' }}">
                                <a href="/theme/components/list_group"> List Group </a>
                            </li>
                            <li class="{{ ($page_name === 'pricing_table') ? 'active' : '' }}">
                                <a href="/theme/components/pricing_tables"> Pricing Tables </a>
                            </li>
                            <li class="{{ ($page_name === 'lightbox') ? 'active' : '' }}">
                                <a href="/theme/components/lightbox"> Lightbox </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ ($category_name === 'elements') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'elements') ? 'show' : '' }}" id="elements" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'alerts') ? 'active' : '' }}">
                                <a href="/theme/elements/alerts"> Alerts </a>
                            </li>
                            <li class="{{ ($page_name === 'avatars') ? 'active' : '' }}">
                                <a href="/theme/elements/avatars"> Avatars </a>
                            </li>
                            <li class="{{ ($page_name === 'badges') ? 'active' : '' }}">
                                <a href="/theme/elements/badges"> Badges </a>
                            </li>
                            <li class="{{ ($page_name === 'breadcrumbs') ? 'active' : '' }}">
                                <a href="/theme/elements/breadcrumbs"> Breadcrumbs </a>
                            </li>
                            <li class="{{ ($page_name === 'buttons') ? 'active' : '' }}">
                                <a href="/theme/elements/buttons"> Buttons </a>
                            </li>
                            <li class="{{ ($page_name === 'button_group') ? 'active' : '' }}">
                                <a href="/theme/elements/button_group"> Button Group </a>
                            </li>
                            <li class="{{ ($page_name === 'color_library') ? 'active' : '' }}">
                                <a href="/theme/elements/color_library"> Color Library </a>
                            </li>
                            <li class="{{ ($page_name === 'dropdown') ? 'active' : '' }}">
                                <a href="/theme/elements/dropdown"> Dropdown </a>
                            </li>
                            <li class="{{ ($page_name === 'infobox') ? 'active' : '' }}">
                                <a href="/theme/elements/infobox"> Infobox </a>
                            </li>
                            <li class="{{ ($page_name === 'jumbotron') ? 'active' : '' }}">
                                <a href="/theme/elements/jumbotron"> Jumbotron </a>
                            </li>
                            <li class="{{ ($page_name === 'loaders') ? 'active' : '' }}">
                                <a href="/theme/elements/loaders"> Loader </a>
                            </li>
                            <li class="{{ ($page_name === 'pagination') ? 'active' : '' }}">
                                <a href="/theme/elements/pagination"> Pagination </a>
                            </li>
                            <li class="{{ ($page_name === 'popovers') ? 'active' : '' }}">
                                <a href="/theme/elements/popovers"> Popovers </a>
                            </li>
                            <li class="{{ ($page_name === 'progress_bar') ? 'active' : '' }}">
                                <a href="/theme/elements/progress_bar"> Progress Bar </a>
                            </li>
                            <li class="{{ ($page_name === 'search') ? 'active' : '' }}">
                                <a href="/theme/elements/search"> Search </a>
                            </li>
                            <li class="{{ ($page_name === 'tooltips') ? 'active' : '' }}">
                                <a href="/theme/elements/tooltips"> Tooltips </a>
                            </li>
                            <li class="{{ ($page_name === 'treeview') ? 'active' : '' }}">
                                <a href="/theme/elements/treeview"> Treeview </a>
                            </li>
                            <li class="{{ ($page_name === 'typography') ? 'active' : '' }}">
                                <a href="/theme/elements/typography"> Typography </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ ($category_name === 'fonticons') ? 'active' : '' }}">
                        <a href="/theme/font_icons" data-active="{{ ($category_name === 'fonticons') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'fonticons') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'widgets') ? 'active' : '' }}">
                        <a href="/theme/widgets" data-active="{{ ($category_name === 'widgets') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'widgets') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'bootstrap_basic_table') ? 'active' : '' }}">
                        <a href="/theme/tables/bootstrap_basic" data-active="{{ ($category_name === 'bootstrap_basic_table') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'bootstrap_basic_table') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'datatable') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'datatable') ? 'show' : '' }}" id="datatables" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'basic') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/basic"> Basic </a>
                            </li>
                            <li class="{{ ($page_name === 'basic-light') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/basic-light"> Light </a>
                            </li>
                            <li class="{{ ($page_name === 'ordering_sorting') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/ordering_sorting"> Order Sorting </a>
                            </li>
                            <li class="{{ ($page_name === 'multi-column_ordering') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/multi-column_ordering"> Multi-Column </a>
                            </li>
                            <li class="{{ ($page_name === 'multiple_tables') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/multiple_tables"> Multiple Tables</a>
                            </li>
                            <li class="{{ ($page_name === 'alternative_pagination') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/alternative_pagination"> Alt. Pagination</a>
                            </li>
                            <li class="{{ ($page_name === 'custom') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/custom"> Custom </a>
                            </li>
                            <li class="{{ ($page_name === 'range_search') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/range_search"> Range Search </a>
                            </li>
                            <li class="{{ ($page_name === 'html5') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/html5"> HTML5 Export </a>
                            </li>
                            <li class="{{ ($page_name === 'live_dom_ordering') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/live_dom_ordering"> Live DOM ordering </a>
                            </li>
                            <li class="{{ ($page_name === 'miscellaneous') ? 'active' : '' }}">
                                <a href="/theme/tables/datatables/miscellaneous"> Miscellaneous </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ ($category_name === 'forms') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'forms') ? 'show' : '' }}" id="forms" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'basic') ? 'active' : '' }}">
                                <a href="/theme/forms/basic"> Basic </a>
                            </li>
                            <li class="{{ ($page_name === 'input_group') ? 'active' : '' }}">
                                <a href="/theme/forms/input_group"> Input Group </a>
                            </li>
                            <li class="{{ ($page_name === 'layouts') ? 'active' : '' }}">
                                <a href="/theme/forms/layouts"> Layouts </a>
                            </li>
                            <li class="{{ ($page_name === 'validation') ? 'active' : '' }}">
                                <a href="/theme/forms/validation"> Validation </a>
                            </li>
                            <li class="{{ ($page_name === 'input_mask') ? 'active' : '' }}">
                                <a href="/theme/forms/input_mask"> Input Mask </a>
                            </li>
                            <li class="{{ ($page_name === 'bootstrap_select') ? 'active' : '' }}">
                                <a href="/theme/forms/bootstrap_select"> Bootstrap Select </a>
                            </li>
                            <li class="{{ ($page_name === 'select2') ? 'active' : '' }}">
                                <a href="/theme/forms/select2"> Select2 </a>
                            </li>
                            <li class="{{ ($page_name === 'touchspin') ? 'active' : '' }}">
                                <a href="/theme/forms/touchspin"> TouchSpin </a>
                            </li>
                            <li class="{{ ($page_name === 'maxlength') ? 'active' : '' }}">
                                <a href="/theme/forms/maxlength"> Maxlength </a>
                            </li>
                            <li class="{{ ($page_name === 'checkbox_radio') ? 'active' : '' }}">
                                <a href="/theme/forms/checkbox_radio"> Checkbox &amp; Radio </a>
                            </li>
                            <li class="{{ ($page_name === 'switches') ? 'active' : '' }}">
                                <a href="/theme/forms/switches"> Switches </a>
                            </li>
                            <li class="{{ ($page_name === 'wizards') ? 'active' : '' }}">
                                <a href="/theme/forms/wizards"> Wizards </a>
                            </li>
                            <li class="{{ ($page_name === 'file_upload') ? 'active' : '' }}">
                                <a href="/theme/forms/file_upload"> File Upload </a>
                            </li>
                            <li class="{{ ($page_name === 'quill') ? 'active' : '' }}">
                                <a href="/theme/forms/quill_editor"> Quill Editor </a>
                            </li>
                            <li class="{{ ($page_name === 'markdown') ? 'active' : '' }}">
                                <a href="/theme/forms/markdown_editor"> Markdown Editor </a>
                            </li>
                            <li class="{{ ($page_name === 'date_range_picker') ? 'active' : '' }}">
                                <a href="/theme/forms/date_range_picker"> Date &amp; Range Picker </a>
                            </li>
                            <li class="{{ ($page_name === 'clipboard') ? 'active' : '' }}">
                                <a href="/theme/forms/clipboard"> Clipboard </a>
                            </li>
                            <li class="{{ ($page_name === 'typeahead') ? 'active' : '' }}">
                                <a href="/theme/forms/typeahead"> Typeahead </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ ($category_name === 'users') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'users') ? 'show' : '' }}" id="users" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'profile') ? 'active' : '' }}">
                                <a href="/theme/users/profile"> Profile </a>
                            </li>
                            <li class="{{ ($page_name === 'account_setting') ? 'active' : '' }}">
                                <a href="/theme/users/account_settings"> Account Settings </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ ($category_name === 'pages') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'pages') ? 'show' : '' }}" id="pages" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'helpdesk') ? 'active' : '' }}">
                                <a href="/theme/pages/helpdesk"> Helpdesk </a>
                            </li>
                            <li class="{{ ($page_name === 'contact_us') ? 'active' : '' }}">
                                <a href="/theme/pages/contact_us_form"> Contact Form </a>
                            </li>
                            <li class="{{ ($page_name === 'faq') ? 'active' : '' }}">
                                <a href="/theme/pages/faq"> FAQ </a>
                            </li>
                            <li class="{{ ($page_name === 'faq2') ? 'active' : '' }}">
                                <a href="/theme/pages/faq2"> FAQ 2 </a>
                            </li>
                            <li class="{{ ($page_name === 'privacy') ? 'active' : '' }}">
                                <a href="/theme/pages/privacy_policy"> Privacy Policy </a>
                            </li>
                            <li class="{{ ($page_name === 'coming_soon') ? 'active' : '' }}">
                                <a href="/theme/pages/coming_soon"> Coming Soon </a>
                            </li>
                            <li class="{{ ($page_name === 'dashboard') ? 'active' : '' }}">
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="pages-error" data-parent="#pages">
                                    <li class="{{ ($page_name === 'error404') ? 'active' : '' }}">
                                        <a href="/theme/pages/error_404"> 404 </a>
                                    </li>
                                    <li class="{{ ($page_name === 'error500') ? 'active' : '' }}">
                                        <a href="/theme/pages/error_500"> 500 </a>
                                    </li>
                                    <li class="{{ ($page_name === 'error503') ? 'active' : '' }}">
                                        <a href="/theme/pages/error_503"> 503 </a>
                                    </li>
                                    <li class="{{ ($page_name === 'maintenence') ? 'active' : '' }}">
                                        <a href="/theme/pages/maintenence"> Maintanence </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="menu {{ ($category_name === 'auth') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'auth') ? 'show' : '' }}" id="authentication" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'auth_boxed') ? 'active' : '' }}">
                                <a href="/theme/authentication/login_boxed"> Login Boxed </a>
                            </li>
                            <li class="{{ ($page_name === 'auth_boxed') ? 'active' : '' }}">
                                <a href="/theme/authentication/register_boxed"> Register Boxed </a>
                            </li>
                            <li class="{{ ($page_name === 'auth_boxed') ? 'active' : '' }}">
                                <a href="/theme/authentication/lockscreen_boxed"> Unlock Boxed </a>
                            </li>
                            <li class="{{ ($page_name === 'auth_boxed') ? 'active' : '' }}">
                                <a href="/theme/authentication/pass_recovery_boxed"> Recover ID Boxed </a>
                            </li>
                            <li class="{{ ($page_name === 'auth_default') ? 'active' : '' }}">
                                <a href="/theme/authentication/login"> Login Cover </a>
                            </li>
                            <li class="{{ ($page_name === 'auth_default') ? 'active' : '' }}">
                                <a href="/theme/authentication/register"> Register Cover </a>
                            </li>
                            <li class="{{ ($page_name === 'auth_default') ? 'active' : '' }}">
                                <a href="/theme/authentication/lockscreen"> Unlock Cover </a>
                            </li>
                            <li class="{{ ($page_name === 'auth_default') ? 'active' : '' }}">
                                <a href="/theme/authentication/pass_recovery"> Recover ID Cover </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ ($category_name === 'drag_n_drop') ? 'active' : '' }}">
                        <a href="/theme/drag_and_drop" data-active="{{ ($category_name === 'drag_n_drop') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'drag_n_drop') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'maps') ? 'active' : '' }}">
                        <a href="/theme/maps" data-active="{{ ($category_name === 'maps') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'maps') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'charts') ? 'active' : '' }}">
                        <a href="/theme/charts" data-active="{{ ($category_name === 'charts') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'charts') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                            <li>
                                <a href="/theme/starter-kit/blank_page"> Blank Page </a>
                            </li>
                            <li>
                                <a href="/theme/starter-kit/breadcrumbs"> Breadcrumbs </a>
                            </li>
                            <li>
                                <a href="/theme/starter-kit/boxed"> Boxed </a>
                            </li>
                            <li>
                                <a href="/theme/starter-kit/alternative_menu"> Alternate Menu </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ ($category_name === 'starter_kits') ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'starter_kits') ? 'show' : '' }}" id="starter-kit" data-parent="#accordionExample">
                            ...
                            <li class="{{ ($page_name === 'breadcrumb') ? 'active' : '' }}">
                                <a href="/theme/starter-kit/breadcrumbs"> Breadcrumb </a>
                            </li>
