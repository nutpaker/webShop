                                ...
                                <div class="widget-content widget-content-area simple-tab">
                                    ...
                                    <div class="tab-content" id="simpletabContent">
                                        ...
                                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <div class="media">
                                                <img class="mr-3" src="{{asset('storage/backend/img/90x90.jpg')}}" alt="Generic placeholder image">
                                        ...
                                        <div class="col-sm-9 col-12">
                                            <div class="tab-content" id="v-border-pills-tabContent">
                                              ...
                                              <div class="tab-pane fade" id="v-border-pills-profile" role="tabpanel" aria-labelledby="v-border-pills-profile-tab">
                                                ...
                                                <div class="media">
                                                    <img class="mr-3 rounded-circle" src="{{asset('storage/backend/img/90x90.jpg')}}" alt="Generic placeholder image">
                                                    <div class="media-body">
                                ...
                                <div class="widget-content widget-content-area border-tab">
                                    ...
                                    <div class="tab-content mb-4" id="border-tabsContent">
                                        ...
                                        <div class="tab-pane fade" id="border-profile" role="tabpanel" aria-labelledby="border-profile-tab">
                                            <div class="media">
                                                <img class="meta-usr-img mr-3" src="{{asset('storage/backend/img/90x90.jpg')}}" alt="Generic placeholder image">
                                                <div class="media-body">
                                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                                </div>
                                            </div>
