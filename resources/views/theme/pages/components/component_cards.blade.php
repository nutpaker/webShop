                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="card component-card_2">
                                        <img src="{{asset('storage/backend/img/400x300.jpg')}}" class="card-img-top" alt="widget-card-2">
                                        <div class="card-body">
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="card component-card_3">
                                        <div class="card-body">
                                            <img src="{{asset('storage/backend/img/90x90.jpg')}}" class="card-img-top" alt="...">
                                    ...
                                    <div class="card component-card_4">
                                        <div class="card-body">
                                            <div class="user-profile">
                                                <img src="{{asset('storage/backend/img/90x90.jpg')}}" class="" alt="...">
                                            </div>
                                            <div class="user-info">
                                                <h5 class="card-user_name">Luke Ivory</h5>
                                                <p class="card-user_occupation">Manager</p>
                                                        ...
                                                        <div class="col-md-12">
                                                            <ul class="list-inline badge-collapsed-img mb-0 mb-3">
                                                                <li class="list-inline-item chat-online-usr">
                                                                    <img alt="avatar" src="{{asset('storage/backend/img/90x90.jpg')}}" class="ml-0">
                                                                </li>
                                                                <li class="list-inline-item chat-online-usr">
