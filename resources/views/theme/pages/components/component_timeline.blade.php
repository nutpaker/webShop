                                        ...
                                        <div class="timeline-list">
                                            ...
                                            <div class="timeline-post-content">
                                                <div class="user-profile">
                                                    <img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="">
                                                </div>
                                                <div class="">
                                                    <h4>Laurie Fox</h4>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="post-gallery-img">
                                                            <img src="{{asset('storage/backend/img/400x300.jpg')}}" alt="timeline">
                                                            <img src="{{asset('storage/backend/img/400x300.jpg')}}" alt="timeline">
                                                            <img src="{{asset('storage/backend/img/400x300.jpg')}}" alt="timeline">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="timeline-post-content">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        consequat.</p>
                                                        <div class="post-contributers">
                                                            <img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="timeline">
                                                            <img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="timeline">
                                                            <img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="timeline">
                                                            <img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="timeline">
                                                            <img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="timeline">
...
&lt;div class="timeline-simple"&gt;
    ...
    &lt;div class="timeline-list"&gt;
        ...
        &lt;div class="timeline-post-content"&gt;
            &lt;div class="user-profile"&gt;
                &lt;img src="{{asset('storage/backend/img/90x90.jpg')}}" class=""&gt;
            &lt;/div&gt;
            &lt;div class=""&gt;
                &lt;h4&gt;Laurie Fox&lt;/h4&gt;
                &lt;p class="meta-time-date"&gt;5 sec&lt;/p&gt;
        ...
        &lt;div class="timeline-post-content post-gallery"&gt;
            ...
            &lt;div class=""&gt;
                ...
                &lt;div class=""&gt;
                    ...
                    consequat.&lt;/p&gt;
                    &lt;div class="post-gallery-img"&gt;
                        &lt;img src="{{asset('storage/backend/img/400x300.jpg')}}" class=""&gt;
                        &lt;img src="{{asset('storage/backend/img/400x300.jpg')}}" class=""&gt;
                        &lt;img src="{{asset('storage/backend/img/400x300.jpg')}}" class=""&gt;
                    &lt;/div&gt;
                &lt;/div&gt;
                                                ...
                                                <ul class="modern-timeline pl-0">
                                                    <li>
                                                        ...
                                                        <div class="modern-timeline-panel">
                                                            <div class="modern-timeline-preview"><img src="{{asset('storage/backend/img/509x343.jpg')}}" alt="timeline"></div>
...
&lt;div class="mt-container mx-auto"&gt;
    &lt;div class="timeline-alter"&gt;
        ...
        &lt;div class="item-timeline"&gt;
            ...
            &lt;/div&gt;
            &lt;div class="t-img"&gt;
                &lt;img src="{{asset('storage/backend/img/90x90.jpg')}}"&gt;
            &lt;/div&gt;
            &lt;div class="t-meta-time"&gt;
                &lt;p class=""&gt;25 mins ago&lt;/p&gt;
            &lt;/div&gt;
