                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                        <div class="widget widget-card-one">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">
                                    </div>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">Andy King</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">Irene Collins</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">Laurie Fox</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">Luke Ivory</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">Ryan Collins</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">Nia Hillyer</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="avatar">Sonia Shaw</div></td>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="product">Speakers</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="product">Sunglasses</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="product">Watch</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="product">Laptop</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="product">Camera</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="product">Shoes</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('storage/backend/img/90x90.jpg')}}" alt="product">Headphone</div></td>
