                        ...
                        <div id="avatarShapes" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area image-style-content text-center">
                                    ...
                                    <div class="avatar avatar-xl">
                                        <img alt="avatar" src="{{asset('storage/backend/img/90x90.jpg')}}" class="rounded" />
                                    </div>
                                    <div class="avatar avatar-xl">
                                        <img alt="avatar" src="{{asset('storage/backend/img/90x90.jpg')}}" class="rounded-circle" />
                                    </div>
                        ...
                        <div id="avatarTooltip" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area image-style-content text-center">
                                    ...
                                    <div class="avatar--group">
                                        <div class="avatar">
                                            <img alt="avatar" src="{{asset('storage/backend/img/90x90.jpg')}}" class="rounded-circle  bs-tooltip" data-original-title="Judy Holmes" />
                                        </div>
                                        <div class="avatar">
                                            <img alt="avatar" src="{{asset('storage/backend/img/90x90.jpg')}}" class="rounded-circle  bs-tooltip" data-original-title="Judy Holmes" />
                                        </div>
