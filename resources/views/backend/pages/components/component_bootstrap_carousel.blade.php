                                                ...
                                                <div id="style1" class="carousel slide style-custom-1" data-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                            <img class="d-block w-100 slide-image" src="{{asset('storage/backend/img/600x300.jpg')}}" alt="First slide">
                                                            <div class="carousel-caption">
                                                                <span class="badge">Lifestyle</span>
                                                                <h3>How To Make More Blog By Doing Less</h3>
                                                                <div class="media">
                                                                    <img src="{{asset('storage/backend/img/90x90.jpg')}}" class="" alt="avatar">
                                                        ...
                                                        <div class="carousel-item">
                                                            <img class="d-block w-100 slide-image" src="{{asset('storage/backend/img/600x300.jpg')}}" alt="Second slide">
                                                            <div class="carousel-caption">
                                                                <span class="badge">Lifestyle</span>
                                                        ...
                                                        <div class="carousel-item">
                                                            <img class="d-block w-100 slide-image" src="{{asset('storage/backend/img/600x300.jpg')}}" alt="Third slide">
                                                            <div class="carousel-caption">
                                                                <span class="badge">Lifestyle</span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="d-block w-100" src="{{asset('storage/backend/img/600x300.jpg')}}" alt="First slide">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="{{asset('storage/backend/img/600x300.jpg')}}" alt="Second slide">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="{{asset('storage/backend/img/600x300.jpg')}}" alt="Third slide">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
