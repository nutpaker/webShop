            ...
            <div class="row">
                ...
                <div class="col-md-6 order-md-0 order-0">
                    <a target="_blank" href="#" class="banner-img">
                        <img src="{{asset('storage/backend/img/faq.svg')}}" class="d-block" alt="header-image">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="fq-article-section">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
                        <div class="card">
                            <img src="{{asset('storage/backend/img/400x300.jpg')}}" class="card-img-top" alt="faq-video-tutorials">
                            <div class="card-body">
                                <div class="fq-rating">
