...
@switch($page_name)
    ...
    @case('calendar')
      ...
      <script src="{{asset('backend/plugins/fullcalendar/custom-fullcalendar.advance.js')}}"></script>
      @break
    ...
    @case('mailbox')
      {{-- App Mailbox --}}
      <script src="{{asset('backend/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      ...
      <script src="{{asset('backend/assets/js/apps/custom-mailbox.js')}}"></script>
      @break

    @case('notes')
      {{-- App Notes --}}
      <script src="{{asset('backend/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      <script src="{{asset('backend/assets/js/apps/notes.js')}}"></script>
      @break
    ...
    @case('scrumboard')
      ...
      <script src="{{asset('backend/plugins/jquery-ui/jquery-ui.min.js')}}"></script>
      <script src="{{asset('backend/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      <script src="{{asset('backend/assets/js/apps/scrumboard.js')}}"></script>
      @break
    ...
    @case('todo-list')
      ...
      <script src="{{asset('backend/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      <script src="{{asset('backend/plugins/editors/quill/quill.js')}}"></script>
      <script src="{{asset('backend/assets/js/apps/todoList.js')}}"></script>
      @break
    ...
    @case('blockui')
      ...
      <script src="{{asset('backend/plugins/blockui/custom-blockui.js')}}"></script>
      @break
    ...
    @case('countdown')
      ...
      <script src="{{asset('backend/assets/js/scrollspyNav.js')}}"></script>
      <script src="{{asset('backend/plugins/countdown/jquery.countdown.min.js')}}"></script>
      <script src="{{asset('backend/assets/js/components/custom-countdown.js')}}"></script>
      @break

    @case('counter')
      <script src="{{asset('backend/assets/js/scrollspyNav.js')}}"></script>
      <script src="{{asset('backend/plugins/counter/jquery.countTo.js')}}"></script>
      <script src="{{asset('backend/assets/js/components/custom-counter.js')}}"></script>
      @break
    ...
    @case('session_timeout')
      ...
      <script src="{{asset('backend/assets/js/components/session-timeout/bootstrap-session-timeout.js')}}"></script>
      <script src="{{asset('backend/assets/js/components/session-timeout/custom-bootstrap_session_timeout.js')}}"></script>
      @break
    ...
    @case('popovers')
      {{-- Element popovers --}}
      <script src="{{asset('backend/assets/js/elements/popovers.js')}}"></script>
      @break

    @case('search')
      {{-- Elements Serach --}}
      <script src="{{asset('backend/assets/js/elements/custom-search.js')}}"></script>
      @break
    ...
    @case('treeview')
      {{-- Elements Treeview --}}
      <script src="{{asset('backend/plugins/treeview/custom-jstree.js')}}"></script>
      <script src="{{asset('backend/assets/js/scrollspyNav.js')}}"></script>
      @break
    ...
    @case('maps')
      {{-- Maps Jvector --}}
      <script src="{{asset('backend/assets/js/scrollspyNav.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/jquery-jvectormap-2.0.3.min.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/africa/jquery-jvectormap-africa-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/asia/jquery-jvectormap-asia-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/continents/jquery-jvectormap-continents-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/europe/jquery-jvectormap-europe-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/north_america/jquery-jvectormap-north-america-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/oceania/jquery-jvectormap-oceanina-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/south-america/jquery-jvectormap-south-america-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/worldmap_script/jquery-jvectormap-world-mill-en.js')}}"></script>
      <script src="{{asset('backend/plugins/jvector/jvector_script.js')}}"></script>
      @break
    ...
    @case('faq')
      {{-- Pages FAQ --}}
      <script src="{{asset('backend/assets/js/pages/faq/faq.js')}}"></script>
      @break

    @case('faq2')
      {{-- Pages FAQ2 --}}
      <script src="{{asset('backend/assets/js/pages/faq/faq2.js')}}"></script>
      @break

    @case('helpdesk')
      {{-- Pages Helpdesk --}}
      <script src="{{asset('backend/assets/js/pages/helpdesk.js')}}"></script>
      @break
    ...
    @case('miscellaneous')
      ...
      <script src="{{asset('backend/plugins/table/datatable/datatables.js')}}"></script>
      <script src="{{asset('backend/plugins/table/datatable/custom_miscellaneous.js')}}"></script>
      @break
    ...
    @case('clipboard')
      ...
      <script src="{{asset('backend/assets/js/forms/custom-clipboard.js')}}"></script>
      @break
    ...
    @case('typeahead')
      ...
      <script src="{{asset('backend/plugins/autocomplete/jquery.autocomplete.js')}}"></script>
      <script src="{{asset('backend/plugins/autocomplete/countries.js')}}"></script>
      <script src="{{asset('backend/plugins/autocomplete/demo.js')}}"></script>
      @break
