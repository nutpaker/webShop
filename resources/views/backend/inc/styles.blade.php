...
<link href="{{asset('backend/assets/css/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
    ...
    @case('calendar')
      {{-- App Calendar --}}
      <link href="{{asset('backend/plugins/fullcalendar/fullcalendar.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/plugins/fullcalendar/custom-fullcalendar.advance.css')}}" rel="stylesheet" type="text/css" />
    ...
    @case('mailbox')
      ...
      <link href="{{asset('backend/assets/css/apps/mailbox.css')}}" rel="stylesheet" type="text/css" />
      <script src="backend/plugins/sweetalerts/promise-polyfill.js"></script>
    ...
    @case('notes')
      {{-- App Notes --}}
      <link href="{{asset('backend/assets/css/apps/notes.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/forms/theme-checkbox-radio.css')}}" rel="stylesheet" type="text/css" />
      @break

    @case('scrumboard')
      {{-- App Scrumboard --}}
      <link href="{{asset('backend/assets/css/apps/scrumboard.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/forms/theme-checkbox-radio.css')}}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('todo-list')
      {{-- App Todo List --}}
      <link rel="stylesheet" type="text/css" href="{{asset('backend/plugins/editors/quill/quill.snow.css')}}">
      <link href="{{asset('backend/assets/css/apps/todolist.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('countdown')
      {{-- Compoents Countdown --}}
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/components/custom-countdown.css')}}" rel="stylesheet" type="text/css">
      @break

    @case('counter')
      {{-- Component Counter --}}
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/components/custom-counter.css')}}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('list_group')
      {{-- Compoent List Group --}}
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/components/custom-list-group.css')}}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('media_object')
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('backend/assets/css/forms/theme-checkbox-radio.css')}}">
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/components/custom-media_object.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('timeline')
      {{-- Component Timeline --}}
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/components/timeline/custom-timeline.css')}}" rel="stylesheet" type="text/css" />
      <style>
    ...
    @case('badges')
      {{-- Elements Badges --}}
      <link href="{{asset('backend/plugins/tagInput/tags-input.css')}}" rel="stylesheet" type="text/css" />
      <style>
    ...
    @case('color_library')
      ...
      <link href="{{asset('backend/assets/css/elements/color_library.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('infobox')
      {{-- Elements Infobox --}}
      <link href="{{asset('backend/assets/css/elements/infobox.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('popovers')
      {{-- Elements Popovers --}}
      <link href="{{asset('backend/assets/css/elements/popover.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('treeview')
      {{-- Elements Tree View --}}
      <link href="{{asset('backend/assets/css/elements/custom-tree_view.css')}}" rel="stylesheet" type="text/css" />
      @break

    @case('typography')
      {{-- Elements Typography --}}
      <link href="{{asset('backend/assets/css/elements/custom-typography.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('maps')
      {{-- Maps --}}
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/plugins/jvector/jquery-jvectormap-2.0.3.css')}}" rel="stylesheet" type="text/css" />
      <style>
    ...
    @case('contact_us')
      {{-- Pages Contact Us --}}
      <link href="{{asset('backend/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/pages/contact_us.css')}}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{asset('backend/assets/css/forms/theme-checkbox-radio.css')}}">
      <style>
        #content {
            width: 100%;
    ...
    @case('error500')
      {{-- Pages Error 500 --}}
      <link href="{{asset('backend/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/pages/error/style-500.css')}}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    @case('error503')
      {{-- Pages Error 503 --}}
      <link href="{{asset('backend/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/pages/error/style-503.css')}}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    @case('faq')
      {{-- Pages Faq --}}
      <link href="{{asset('backend/assets/css/main.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/pages/faq/faq.css')}}" rel="stylesheet" type="text/css" />
      @break

    @case('faq2')
      {{-- Pages Faq 2 --}}
      <link href="{{asset('backend/assets/css/pages/faq/faq2.css')}}" rel="stylesheet" type="text/css" />
      @break

    @case('helpdesk')
      {{-- Pages Helpdesk --}}
      <link href="{{asset('backend/assets/css/main.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/pages/helpdesk.css')}}" rel="stylesheet" type="text/css" />
      @break

    @case('maintenence')
      {{-- Pages Maintenence --}}
      <link href="{{asset('backend/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/pages/error/style-maintanence.css')}}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-left: 0;
    ...
    @case('privacy')
      {{-- Pages Privacy --}}
      <link href="{{asset('backend/assets/css/main.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/assets/css/pages/privacy/privacy.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('basic-light')
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('backend/plugins/table/datatable/datatables-light.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('backend/plugins/table/datatable/dt-global_style-light.css')}}">
      @break
    ...
    @case('miscellaneous')
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('backend/plugins/table/datatable/datatables.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('backend/plugins/table/datatable/custom_dt_miscellaneous.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('backend/assets/css/forms/theme-checkbox-radio.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('backend/plugins/table/datatable/dt-global_style.css')}}">
      @break
    ...
    @case('clipboard')
      {{-- Forms Clipboard --}}
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{asset('backend/assets/css/forms/custom-clipboard.css')}}">
      @break
    ...
    @case('typeahead')
      {{-- Forms Typeahead --}}
      <link href="{{asset('backend/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('backend/plugins/autocomplete/autocomplete.css')}}" rel="stylesheet" type="text/css" />
      <style>
