...
import { initBackgrounds } from './parts/initBackgrounds';
...
import { initPluginModal } from './parts/initPluginModal';
...
class Web {
    ...
    initBackgrounds($context) {
        return initBackgrounds.call(this, $context);
    }
    ...
    initPluginModal($context) {
        return initPluginModal.call(this, $context);
    }
